...
export default function ProfilePage() {
  ...
  const isAdmin = user?.email === 'alex@example.com'
          ...
          <>
            ...
            <div className="bg-dark-800 rounded-xl border border-dark-700 p-8 mb-8">
              <div className="flex items-center gap-6 mb-8">
                <div className="w-20 h-20 bg-gradient-to-br from-coins to-yellow-400 rounded-full flex items-center justify-center">
