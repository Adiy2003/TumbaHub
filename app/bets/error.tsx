    ...
    <div className="min-h-screen bg-dark-900 pb-24">
      <header className="border-b border-dark-700 bg-dark-800 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <h1 className="text-3xl font-bold text-white">🎲 Bets</h1>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center py-20">
          ...
          <h2 className="text-2xl font-bold text-white mb-4">Error Loading Bets</h2>
          <p className="text-dark-400 mb-8 max-w-md mx-auto">
            {error.message || 'There was a problem loading the bets. Please try again.'}
          </p>
          <button
            onClick={reset}
